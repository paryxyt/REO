...
%Fcomp_exp =-log(By.*log(Cy./By)-Dy-s1)-log(By)-log(Cy); %old, mistakeb
...
gradFcomp(:,i) = L*[ -1/(Byi*log(Cyi/Byi)+Dyi+s1i); % made corrections up to here
...
Hys1(:,i)=L*[ 1/(Byi*log(Cyi/Byi)-Dyi-s1i).^2;
